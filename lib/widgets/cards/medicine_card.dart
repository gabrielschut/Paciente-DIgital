            ...
            children: [
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text( widget.medicine.nome,
                      style: TextStyle(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      "De: " + DateFormat("dd/MM/yyyy").format(widget.medicine.dataInicial),
                      style: TextStyle(
                        color: Colors.blueAccent,
                        fontSize: 17,
                        fontWeight: FontWeight.bold,
                    ...
                    Text(
                      "Até: " +  DateFormat("dd/MM/yyyy").format(widget.medicine.dataTermino),
                      style: TextStyle(
                        color: Colors.blueAccent,
                        fontSize: 17,
                        fontWeight: FontWeight.bold,
