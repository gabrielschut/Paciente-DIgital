          ...
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              FloatingActionButton(
                onPressed: () async {
                  PacienteDatabaseHelper.create(nameController.text, sexoController.text,
                      int.parse(idadeController.text), tipoSanguineoController.text, double.tryParse(pesoController.text),
                      int.tryParse(alturaController.text), double.tryParse(circAbdominalController.text));
